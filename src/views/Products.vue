        ...
        <table id="tasks" class="ui celled compact table">
            ...
            <tr v-for="(product, i) in products" :key="i">
                ...
                <td width="75" class="center aligned">
                    <router-link :to="{ name: 'edit-product', params: { id: product.id, product }}">Edit</router-link>
                </td>
                <td width="75" class="center aligned" @click.prevent="onDestroy(product.id)">
    ...
    export default {
        ...
        methods: {
            async onDestroy(id) {
                ...
                this.$toastr.s("SUCCESS", "Product deleted sucessfully");
